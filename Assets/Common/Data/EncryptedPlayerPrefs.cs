// Credit: Written by Sven Magnus. MD5 code by Matthew Wegner (from [url]http://www.unifycommunity.com/wiki/index.php?title=MD5[/url])
using UnityEngine;
...
public static class EncryptedPlayerPrefs
{
    ...
    public static string[] keys = new string[]{ "rabbit", "turtle", "llama", "raccoon", "deer", "bear", "duck", "wolf" };

    // Modify this key in this file
    private static string privateKey = "qX2ERaplJ5RyBm71qkg0";
    ...
    public static void SetFloat(string key, float value)
    {
        ...
        SaveEncryption(key, "float", Mathf.Floor(value * 1000.0f).ToString());
    }
    ...
    public static int GetInt(string key, int defaultValue)
    {
        ...
        if (CheckEncryption(key, "int", value.ToString()) == false)
            return defaultValue;
        return value;
    }
    ...
    public static float GetFloat(string key, float defaultValue)
    {
        ...
        if (CheckEncryption(key, "float", Mathf.Floor(value * 1000.0f).ToString()) == false)
            return defaultValue;
        return value;
    }
    ...
    public static string GetString(string key, string defaultValue)
    {
        ...
        if (CheckEncryption(key, "string", value) == false)
            return defaultValue;
        return value;
    }
    ...
    private static bool CheckEncryption(string key, string type, string value)
    {
        ...
        string secretKey = keys[keyIndex];
        string check     = Md5(type + "_" + privateKey + "_" + secretKey + "_" + value);
        if (PlayerPrefs.HasKey(key + "_encryption_check") == false)
            return false;
