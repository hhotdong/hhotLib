...
public class EncryptedPlayerPrefs  {
    ...
    public static void SaveEncryption(string key, string type, string value) {
        ...
        //string check = Md5(string.Format("{0}_{1}_{2}_{3}", type, privateKey, secretKey, value));
    ...
    public static float GetFloat(string key, float defaultValue) {
        ...
        if(!CheckEncryption(key, "float", Mathf.Floor(value * 1000.0f).ToString())) return defaultValue;
        return value;
    }
